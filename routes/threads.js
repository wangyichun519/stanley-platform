...
長照3.0智慧輔具補助已擴大——AI離床感應器、GPS定位器、智慧藥盒等都納入申請範圍。
...
山與海在這裡相擁，生活節奏自然緩下來。在地農業、漢方資源豐富，照護支持網絡就在左鄰右舍之間。

這裡是 Stanley 品牌出發的地方。我們相信，讓宜花東成為全台灣最幸福的長照區域，不是夢——而是我們每天在做的事。

你呢？你心目中的「好好老去」是什麼樣子的？歡迎留言分享 💬
...
🔴 枸杞：護眼明目，適合用眼過度的照護者
🟡 黃耆：補氣固表、增強免疫，推薦睡眠不佳的長輩
🟤 紅棗：養血補中，每日飲水加入2-3顆即可

三者合用煮成養生茶，每日一杯，是家傳中藥行傳下來的日常智慧。不貴、不複雜，溫養全家。
    ...
    const res = await fetch('https://integrate.api.nvidia.com/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: `你是「Stanley 健康生活顧問」的 Threads 社群小編。品牌定位：花蓮在地、醫護專業、Coffee Priority 精品咖啡療癒、銀髮長照、漢方養生。寫作風格：親切有溫度、專業但不冷硬、偶爾帶一點故事感。只輸出貼文本文，不加任何說明或引號。`
          },
          {
            role: 'user',
