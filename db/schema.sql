...
('阿里山他扶芽有機咖啡豆', 'coffee', '阿里山他扶芽有機農莊嚴選。海拔1600米，有機認證，風味：花香、黑糖、奶油尾韻。150g 精美禮盒裝。', 780, 25, 0),
('哥倫比亞天堂莊園玫瑰茶咖啡', 'coffee', '哥倫比亞天堂莊園（Finca El Paraíso）特殊玫瑰茶發酵處理。風味：玫瑰、荔枝、茉莉，極致花果香。100g 限量進口。', 1280, 15, 0),
('青檸香頌冷萃特調包', 'coffee', '花蓮在地咖啡 × 台灣青檸冷萃特調。清爽果酸、咖啡甘甜交融，適合夏季冷泡。10包/盒，無糖天然配方。', 480, 40, 0);
